...
class RegExps {
    ...
    /**
     *
     * @return Регулярное выражение для {@link xyz.pary.onair.command.parameter.Duration длительности} (" (\\d|\\d\\d):\\d\\d:\\d\\d\\.\\d\\d
     * ")
     */
    ...
    /**
     *
     * @return Регулярное выражение для {@link xyz.pary.onair.command.parameter.ParallelDuration длительности с параллельным выполнением}
     * ("\\((\\d|\\d\\d):\\d\\d:\\d\\d.\\d\\d\\)")
     */
     ...
     *
     * @return Регулярное выражение для {@link xyz.pary.onair.command.parameter.Duration#Duration() нулевой длительности} (" 0 ")
     */
    ...
    /**
     *
     * @return Регулярное выражение для {@link xyz.pary.onair.command.parameter.MarkIn MarkIn} ("&lt;(\\d|\\d\\d):\\d\\d:\\d\\d.\\d\\d&gt;")
     */
    ...
    /**
     *
     * @return Регулярное выражение для {@link xyz.pary.onair.command.parameter.Fade Fade} ("\\[(\\d|\\d\\d)\\.\\d\\d\\]")
     */
    static Pattern fade() {
        //movie <0:42:36.60> 0:10:46.40 [0.12] H:\декабрь\16+\ДоРе Аллегрова.mpeg
